...
| Unit(Bats) | registry schema、lock liveness/reclaim、兄弟path、未登録worktreeを含む上限、dirty/detached、PR state/head SHA、assign、plan/apply間のbase変化、cleanup再開を一時Gitリポジトリで検証します |
